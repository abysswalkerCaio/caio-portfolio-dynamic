<template>
  <form
    class="max-w-[750px] w-3/4 flex flex-col gap-6 bg-zinc-200 shadow-md dark:shadow-zinc-800 dark:bg-zinc-900 p-10 rounded"
  >
    <div class="flex flex-col gap-2 text-zinc-800 dark:text-zinc-200">
      ...
      <input
        ...
        id="name"
        name="name"
        class="rounded p-4 bg-zinc-300 dark:bg-zinc-800 placeholder:text-zinc-500 focus:outline-none"
    ...
    <div class="flex flex-col gap-2 text-zinc-800 dark:text-zinc-200">
      ...
      <textarea
        ...
        id="description"
        name="description"
        class="resize-y rounded p-4 max-h-80 h-32 bg-zinc-300 dark:bg-zinc-800 placeholder:text-zinc-500 focus:outline-none"
